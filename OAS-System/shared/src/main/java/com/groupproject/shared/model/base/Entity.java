...
public abstract class Entity implements Serializable {
    ...
    private Integer id; // Mỗi Entity sẽ có một id duy nhất được tạo tự động khi khởi tạo đối tượng
    ...
    public Entity() {
        ...
        this.id= null ; // Khi chưa được lưu vào databse thì có thể để null
